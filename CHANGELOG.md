...
- `auth_check()` and `auth_refresh()` methods implementing the `Authenticator` protocol — enables `reeln plugins auth meta` for credential verification across Facebook Page and Instagram services
